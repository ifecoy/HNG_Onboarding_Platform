...
while argument:
    ...
    #Ask user if they like their password
...
not lower than seven (7) characters """).upper()
    ...
    while password_loop:
        ...
        if password_query == "YES":
            ...
            password_loop = False
            argument = False
        # Loop to verify password length
        else:
            ...
            while character_len:
                if len(user_password) >= 7:
                    ...
                    onboarding_details.append(customer_info)
                    print(f'Your HNG details are  {onboarding_details}')
        # Print user details if password length is okay
                    character_len = False

                    password_loop = False

                    argument = False
         #Ask user for password if egnth is less than 7
                else:
